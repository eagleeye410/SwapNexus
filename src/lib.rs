...
#[derive(Debug)]
pub struct SwapNexusProcessor {
    verbose: bool,
    processed_count: usize,
}

impl SwapNexusProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting SwapNexus processing");
    
    let mut processor = SwapNexusProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = SwapNexusProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = SwapNexusProcessor::new(false);
